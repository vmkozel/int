...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $this->services['.container.private.twig'] = $instance = new \Twig\Environment($a, ['autoescape' => 'name', 'cache' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/twig'), 'charset' => 'UTF-8', 'debug' => true, 'strict_variables' => true]);
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fj0bmsdpgd', 0, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JM7Kt--6bh', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir((\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/doctrine/orm/Proxies'));
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage(('file:'.\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/profiler')), $a, true);
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\LoggerDataCollector($a, (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/App_KernelDevDebugContainer'), $c));
    ...
    protected function getRouterService()
    {
        ...
        ]))->withContext('router.default', $this), 'kernel::loadRoutes', ['cache_dir' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev'), 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\CompiledUrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\CompiledUrlGeneratorDumper', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableCompiledUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\CompiledUrlMatcherDumper', 'strict_requirements' => true, 'resource_type' => 'service'], ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), ($this->privates['parameter_bag'] ?? ($this->privates['parameter_bag'] = new \Symfony\Component\DependencyInjection\ParameterBag\ContainerBag($this))), $a, 'en');
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2BcT0Whnru', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VPupLiypH-', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GysW7HglgA', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uHcw0pbENy', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pNHsf+zn3o', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ugs+akHUlr', 0, $this->getParameter('container.build_id'), (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.debug' => true,
            'kernel.cache_dir' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev'),
            ...
            'session.save_path' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/sessions'),
            'session.metadata.update_threshold' => 0,
            'form.type_extension.csrf.enabled' => true,
            'form.type_extension.csrf.field_name' => '_token',
            'asset.request_context.base_path' => NULL,
            'asset.request_context.secure' => NULL,
            'validator.mapping.cache.file' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/validation.php'),
            'validator.translation_domain' => 'validators',
            'translator.logging' => false,
            'translator.default_path' => (\dirname(__DIR__, 4).'/translations'),
            'profiler_listener.only_exceptions' => false,
            'profiler_listener.only_master_requests' => false,
            'profiler.storage.dsn' => ('file:'.\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/profiler'),
            'debug.error_handler.throw_at' => -1,
            'debug.container.dump' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/App_KernelDevDebugContainer.xml'),
            ...
            'serializer.mapping.cache.file' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/serialization.php'),
            'twig.form.resources' => [
            ...
            'doctrine.orm.proxy_dir' => (\dirname(__DIR__, 2).''.\DIRECTORY_SEPARATOR.'dev/doctrine/orm/Proxies'),
